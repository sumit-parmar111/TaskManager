...
export const slideUpAnimation=trigger("routeAnimations",[
    ...
    group([
        ...
        query(":leave",[style({transform:"translateY(0%)"}),
...
export const zoomUpAnimation=trigger("routeAnimations",[
    ...
    style({position:'absolute',width:'98%'}), {optional:true}),
    group([
        query(":enter",[style({ transform:"scale(0) translateY(100%)"}),
        animate("0.6s",style({transform:"scale(1) translateY(0%)"}))
        ],{optional:true}),

        query(":leave",[style({transform:"scale(1) translateY(0%)"}),
...
export const zoomLeftAnimation=trigger("routeAnimations",[
    ...
    style({position:'absolute',width:'98%'}), {optional:true}),
    group([
        query(":enter",[style({ transform:"scale(0) translateX(100%)"}),
        animate("0.6s",style({transform:"scale(1) translateX(0%)"}))
        ],{optional:true}),

        query(":leave",[style({transform:"scale(1) translateX(0%)"}),
